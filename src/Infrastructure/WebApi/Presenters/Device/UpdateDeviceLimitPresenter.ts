import { OutputPort, UpdateDeviceLimitOutput } from "EnviroSense/Application/Contracts/mod.ts";
...
export class UpdateDeviceLimitPresenter implements OutputPort<UpdateDeviceLimitOutput> {
