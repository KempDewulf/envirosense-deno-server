...
export type { UpdateDeviceConfigInput } from "./Device/UpdateDeviceConfigInput.ts";
export type { UpdateDeviceConfigOutput } from "./Device/UpdateDeviceConfigOutput.ts";
