...
import { UpdateBuildingOutput, OutputPort } from 'EnviroSense/Application/Contracts/mod.ts';
...
export class UpdateBuildingPresenter implements OutputPort<UpdateBuildingOutput> {
    ...
    protected mapToPresentedData(data: UpdateBuildingOutput): UpdateBuildingPresentedData {
        return {
            id: data.id,
