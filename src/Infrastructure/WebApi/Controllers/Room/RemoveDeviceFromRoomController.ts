...
import { RemoveDeviceFromRoomInput, UseCase } from 'EnviroSense/Application/Contracts/mod.ts';
...
export class RemoveDeviceFromRoomController implements Controller<RemoveDeviceFromRoomRequest> {
